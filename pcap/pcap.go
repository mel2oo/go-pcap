...
func newTCPStreamFactory(clock clockWrapper, outChan chan<- gnet.ParsedNetworkTraffic,
...
func (p *NetworkTrafficParser) ParseFromInterface(interfaceName, bpfFilter string,
	signalClose <-chan struct{}, fs ...gnet.TCPParserFactory) (<-chan gnet.ParsedNetworkTraffic, error) {
...
func (p *NetworkTrafficParser) packetToParsedNetworkTraffic(out chan<- gnet.ParsedNetworkTraffic,
	assembler *reassembly.Assembler, packet gopacket.Packet) {
	defer func() {
